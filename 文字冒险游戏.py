...
option2='将迷情剂向他们抛去'
option3='跳一段社会摇'
#定义______________________________________________________________________________________________
...
if choice2=="1":
    ...
    if choice0==option1:
        choice2_31()
    elif choice0==option2:
        choice2_32()
        end_game()
    elif choice0==option3:
        choice2_33()
